...
export function PaymentGateway({ isOpen, onClose, onSuccess, plan, amount }: PaymentGatewayProps) {
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-md apple-modal">
          <div className="text-center py-8">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Payment Successful!</h3>
            ...
            <div className="apple-card-inner rounded-xl p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="font-semibold text-green-800 dark:text-green-300">Pro Plan Activated</span>
              </div>
            </div>
          </div>
        </DialogContent>
        ...
        <div className="space-y-6">
          ...
          <Card className="apple-card-inner rounded-2xl border-0 shadow-lg apple-hover">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100">WorkForce Pro - Monthly</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Unlimited employees & advanced features</p>
                </div>
                <div className="text-right">
                  <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                    ₹{amount.toLocaleString("en-IN")}
                  </p>
                  <p className="text-sm text-gray-500 dark:text-gray-500">per month</p>
                </div>
              </div>
          ...
          <Card className="apple-card-inner rounded-2xl border-0 shadow-lg apple-hover">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  { method: "card" as PaymentMethod, label: "Card", icon: "💳" },
                  { method: "upi" as PaymentMethod, label: "UPI", icon: "📱" },
                  { method: "netbanking" as PaymentMethod, label: "Net Banking", icon: "🏦" },
                  { method: "wallet" as PaymentMethod, label: "Wallet", icon: "👛" },
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => updatePaymentDetails({ expiryMonth: value })}
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => updatePaymentDetails({ expiryYear: value })}
                      >
                        <SelectTrigger className="apple-input rounded-xl border-2 border-gray-200 dark:border-gray-700">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => updatePaymentDetails({ cvv: e.target.value.replace(/\D/g, "").slice(0, 4) })}
                        className="apple-input rounded-xl border-2 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 px-4 py-3"
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="apple-card-inner rounded-xl p-4 bg-blue-50 dark:bg-blue-900/20">
                    <p className="text-sm text-blue-800 dark:text-blue-300">
                      💡 You can also scan QR code or use popular UPI apps like PhonePe, Google Pay, Paytm
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => updatePaymentDetails({ bank: value })}
                    >
                      <SelectTrigger className="apple-input rounded-xl border-2 border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => updatePaymentDetails({ walletType: value })}
                    >
                      <SelectTrigger className="apple-input rounded-xl border-2 border-gray-200 dark:border-gray-700">
          ...
          <div className="apple-card-inner rounded-xl p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30 apple-hover">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold text-green-800 dark:text-green-300">Secure Payment</p>
