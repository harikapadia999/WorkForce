...
import { logAuth } from "@/services/activity-log-service";
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signIn = async (email: string, password: string) => {
    ...
    await logAuth("Login", { method: "password" });
  };
  ...
  const signUp = async (
    ...
    await logAuth("Login", { method: "password_signup" });
  };
  ...
  const signInWithGoogle = async () => {
    ...
    await logAuth("Login", { method: "google" });
  };
